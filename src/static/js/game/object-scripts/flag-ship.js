function FlagShip(state, shipSpriteKey) {
    ...
    for(var i = 0; i < this.state.allyFighters.length; i++) {
...
FlagShip.prototype = {
    ...
    initialiseTurrets : function(game, turretSpriteKey) {
        ...
        for(var i = 0; i < this.turretCount; i++) {
            ...
            do {
                ...
                for(var j = 0; j < this.aliveSubSystems.length; j++) {
    ...
    aiUpdate : function(targetSprite) {
        ...
        for(var i = 0; i < this.aliveTurrets.length; i++) {
...
Turret.prototype = {
    ...
    die : function() {
        ...
        if(this.sprite.turretId < (this.parentFlagShip.aliveTurrets.length - 1)) {
            for(var i = this.sprite.turretId + 1; i < this.parentFlagShip.aliveTurrets.length; i++) {
...
ShieldGenerator.prototype = {
    ...
    die : function() {
        ...
        if(this.sprite.subSystemId < (this.parentFlagShip.aliveSubSystems.length - 1)) {
            for(var i = this.sprite.subSystemId + 1; i < this.parentFlagShip.aliveSubSystems.length; i++) {
